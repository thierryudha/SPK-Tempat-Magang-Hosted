<?php
$raw = "Daftar Nama Kabupaten dan Kota di Provinsi NAD Aceh :
...
foreach ($lines as $line) {
    ...
    if (strpos($line, "Daftar Nama") !== false) continue;
    
    // Remove "Kabupaten Administrasi ", "Kota Administrasi ", "Kabupaten ", "Kota "
    $line = str_replace(["Kabupaten Administrasi ", "Kota Administrasi ", "Kabupaten ", "Kota "], "", $line);
    $cities[] = $line;
}
