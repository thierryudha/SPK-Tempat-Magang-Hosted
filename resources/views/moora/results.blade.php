    ...
    <div class="py-12 px-4 sm:px-0">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-12 flex flex-col sm:flex-row justify-start gap-4">
                <a href="{{ route('moora.index') }}" class="px-8 py-4 bg-blue-600 text-white font-black rounded-2xl hover:bg-blue-700 shadow-xl shadow-blue-100 transition transform active:scale-95 text-center">Hitung Ulang</a>
                <a href="{{ route('dashboard') }}" class="px-8 py-4 bg-white text-slate-500 font-black rounded-2xl border-2 border-slate-100 hover:bg-slate-50 transition text-center">Kembali ke Dashboard</a>
            </div>
        </div>
    </div>
</x-app-layout>
