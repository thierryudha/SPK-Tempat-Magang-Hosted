                    ...
                    <form action="{{ route('internships.update', $internship) }}" method="POST">
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <x-text-input id="website_link" name="website_link" type="url" class="block w-full bg-slate-50 border-transparent focus:bg-white transition" :value="old('website_link', $internship->website_link)" placeholder="https://perusahaan.com/karir" />
