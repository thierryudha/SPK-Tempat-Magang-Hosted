<x-admin-layout>
    <div class="max-w-3xl mx-auto">
        <div class="mb-10">
            ...
            <h1 class="text-3xl font-black text-slate-900">Tambah Perusahaan Magang</h1>
            <p class="text-slate-500 text-sm mt-2">Masukkan detail perusahaan baru ke dalam direktori sistem.</p>
        </div>

        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 md:p-12">
            <form action="{{ route('admin.internships.store') }}" method="POST" class="space-y-8">
                @csrf
                <div>
