<x-admin-layout>
    <div class="mt-4">
        ...
        <div class="mb-8">
            <h1 class="text-[26px] font-[800] text-[#0F172A] tracking-tight leading-none mb-2">Tambah Perusahaan Baru</h1>
            <p class="text-[14px] text-[#64748B] font-medium">Masukkan detail perusahaan baru ke dalam direktori sistem.</p>
        </div>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" id="name" name="name" 
                                ...
                                required placeholder="Contoh: PT. Teknologi Maju" value="{{ old('name') }}">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="url" id="website_link" name="website_link" 
                                class="w-full h-[48px] px-4 bg-[#F8FAFC] border border-[#E2E8F0] rounded-[10px] text-[14px] font-semibold text-[#0F172A] focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 transition-all" 
                                required placeholder="https://perusahaan.com/karir" value="{{ old('website_link') }}">
                            @error('website_link') <p class="text-rose-500 text-[11px] font-bold mt-1 uppercase tracking-wider">{{ $message }}</p> @enderror
                            <p class="text-[11px] text-[#94A3B8] italic font-medium">Wajib diisi oleh Admin untuk data referensi global.</p>
                        </div>
                    </div>
                </div>
