<x-admin-layout>
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
            <div>
                <h1 class="text-3xl font-black text-slate-900 tracking-tight">Manajemen Kriteria</h1>
                <p class="text-slate-500 text-sm mt-1">Atur parameter penilaian untuk perhitungan metode MOORA.</p>
            </div>
            <a href="{{ route('admin.criterias.create') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white text-xs font-black uppercase tracking-widest rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-500/20 transition">
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-5">
                                <div class="flex justify-end gap-3">
                                    ...
                                    <form action="{{ route('admin.criterias.destroy', $c) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus kriteria ini?')">
                                        @csrf
                                        @method('DELETE')
