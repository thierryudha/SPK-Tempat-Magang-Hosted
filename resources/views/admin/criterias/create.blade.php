<x-admin-layout>
    <div class="mt-4">
        ...
        <div class="mb-8">
            <h1 class="text-[26px] font-[800] text-[#0F172A] tracking-tight leading-none mb-2">Tambah Kriteria Baru</h1>
            <p class="text-[14px] text-[#64748B] font-medium">Definisikan kriteria baru beserta deskripsi skalanya untuk perhitungan MOORA.</p>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" id="name" name="name" 
                                    ...
                                    required placeholder="Contoh: Gaji / Uang Saku" value="{{ old('name') }}">
                        ...
                        <div class="flex items-start gap-4 p-4 bg-[#F8FAFC] rounded-xl border border-[#E2E8F0]/50">
                            ...
                            <div class="flex-1 space-y-2">
                                ...
                                <input type="text" name="scales[{{ $i }}]" 
                                    ...
                                    required placeholder="Contoh: @if($i==1)Sangat Rendah @elseif($i==3)Cukup @elseif($i==5)Sangat Tinggi @endif..." value="{{ old('scales.'.$i) }}">
